  ...
  <div id="teamPage">
    ...
    <van-tabs v-model:active="active" @change="onTabChange">
      <van-tab name="public" title="公开">
        <template #title>
          <van-icon name="http://zk45.oss-cn-shenzhen.aliyuncs.com/zk/202303071914691.png" size="18px"/>
          公开
        </template>
      </van-tab>
      <van-tab name="secret" title="加密">
        <template #title>
          <van-icon name="http://zk45.oss-cn-shenzhen.aliyuncs.com/zk/202303071915266.png" size="18px"/>
          加密
        </template>
      </van-tab>
    </van-tabs>
