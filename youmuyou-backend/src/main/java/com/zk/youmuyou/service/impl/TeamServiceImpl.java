...
import com.zk.youmuyou.mapper.TeamMapper;
...
import com.zk.youmuyou.model.enums.TeamStatusEnum;
...
import com.zk.youmuyou.model.vo.UserVO;
...
public class TeamServiceImpl extends ServiceImpl<TeamMapper, Team>
    ...
    public List<TeamUserVO> listTeams(TeamQuery teamQuery, boolean isAdmin) {
        ...
        if (teamQuery != null) {
            ...
            List<Long> ids = teamQuery.getIdList();
    ...
    public boolean joinTeam(TeamJoinRequest teamJoinRequest, User loginUser) {
        ...
        // 只有一个线程能获取到锁
        RLock lock = redissonClient.getLock("youmuyou:join_team");
        try {
            // 抢到锁并执行
            while (true) {
